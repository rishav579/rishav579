...
- **Agentic systems** with memory, planning, tool use, bounded autonomy, and human approval
- **Enterprise RAG** with authorization-aware retrieval, hybrid search, PII protection, and evaluation
- **AI infrastructure** for model routing, local/cloud inference, cost control, and scale
- **AI observability** for traces, tool calls, hallucination signals, loops, latency, and cost
- **AI-native products** across collaboration, commerce, software engineering, and operations
- **Multilingual and voice AI** designed for real users and real-world constraints
...
**AI/ML:** LLM applications · RAG · agents · LangGraph · embeddings · evaluation · prompt engineering · PyTorch · LoRA · speech AI

**Backend & data:** Python · FastAPI · TypeScript · Next.js · PostgreSQL · pgvector · Redis · RabbitMQ

**Production:** Docker · AWS · Kubernetes/EKS · authentication · RBAC · multi-tenancy · observability · CI/CD

## Engineering principles

- **Reliability over demos:** evaluate behavior, handle failure modes, and make systems observable.
- **Security by design:** enforce authorization at retrieval and action boundaries, not just at the UI.
- **Human control where it matters:** use bounded autonomy, approvals, and audit trails for consequential actions.
- **Product thinking:** optimize for user outcomes, latency, cost, and maintainability—not model novelty alone.
